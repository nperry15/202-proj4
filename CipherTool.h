...
//Date: 4/20/2020
//Description: This is part of the tool used to run all the ciphers
...
//for all of the available types of ciphers
//c for ceasar
const string CHAR_C = "c";
//o for ong
const string CHAR_O = "o";
//v for vigenere
const string CHAR_V = "v";

//each menu selection possible made by the user
