...
//the ASCII value for the start of the capital letters
static const int CAPS_A = 65;
//the ASCII value for the end of the capital letters
static const int CAPS_Z = 90;

//the ASCII value for the start of the lowercase letters
static const int LOWER_A = 97;
//the ASCII value for the end of the lowercase letters
static const int LOWER_Z = 122;

//the ASCII value for a dash value
static const int DASH_ASCII = 45;

//the length of the word ong
static const int ONG_LENGTH = 3;

//the number of letters in the alphabet
static const int NUM_ALPHABET_LETTERS = 26;
